...
export const BUBBLES = {
  win:  ['와 이게 한번에 나오네', '됐다!!!', '개이득 ㅋㅋㅋ', '이 집 뽑기 되네', '사장님 감사합니다', '{item} 겟!', '{item} 내 거다'],
  lose: ['아 XX!!', '{item} 분명 잡았는데...', '한 판만 더', '집게 뭐야 진짜', '내 돈...', '다음엔 된다', '{item} 거의 왔는데'],
  angry:['너무해!!!', '사장 나오라 해', '돈 먹는 기계네', '별점 1개 확정'],
  toilet:['급하다 급해', '휴 살았다', '화장실 깨끗하네'],
  toiletDirty:['으 화장실 냄새...', '여기 청소 안 하나'],
  wanderItem:['{item} 있다!', '저 {item} 귀엽다', '{item} 얼마지', '{item} 뽑고 싶다', '{item} 하나만...'],
  wanderEmpty:['인형이 하나도 없네', '여기 뭐 파는 거야', '빈 기계만 있네', '재고 좀 채워요 사장님'],
  wanderBroken:['저거 고장 아니야?', '기계 불 꺼졌는데', '고장난 거 언제 고치지'],
  wanderPricey:['{item} 너무 비싸다', '한 판에 이 가격?', '가격 실화냐'],
  wanderCheap:['이 가격이면 해볼 만한데', '{item} 싸다 싸'],
  wanderCrowd:['사람 많네', '줄 서야겠다', '여기 핫플이네'],
  wanderQuiet:['조용하네', '손님이 나밖에 없어'],
  vending:['목마르다', '음료 하나'],
  stairs:['2층도 있네', '위층 가볼까'],
};
export const CALLS = [
